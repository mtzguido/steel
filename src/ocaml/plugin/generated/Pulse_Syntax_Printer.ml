          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Syntax.Printer.fst"
                   ...
                   (Prims.of_int (421)) (Prims.of_int (109)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "prims.fst" (Prims.of_int (590))
                   (Prims.of_int (19)) (Prims.of_int (590))
          ...
          (Obj.magic
             (FStar_Tactics_Effect.tac_bind
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Syntax.Printer.fst"
                         (Prims.of_int (421)) (Prims.of_int (46))
                         (Prims.of_int (421)) (Prims.of_int (109)))))
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "prims.fst" (Prims.of_int (590))
                ...
                (Obj.magic
                   (FStar_Tactics_Effect.tac_bind
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range "Pulse.Syntax.Printer.fst"
                               (Prims.of_int (421)) (Prims.of_int (73))
                               (Prims.of_int (421)) (Prims.of_int (109)))))
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range "prims.fst"
                         ...
                         (FStar_Tactics_Effect.tac_bind
                            (FStar_Sealed.seal
                               (Obj.magic
                                  (FStar_Range.mk_range
                                     "Pulse.Syntax.Printer.fst"
                                     (Prims.of_int (421)) (Prims.of_int (81))
                                     (Prims.of_int (421))
                                     (Prims.of_int (109)))))
                            (FStar_Sealed.seal
                               (Obj.magic
                ...
                (fun uu___ ->
                   FStar_Tactics_Effect.lift_div_tac
                     (fun uu___1 ->
                        Prims.strcat (if isrec then "rec " else "") uu___))))
          (fun uu___ ->
             FStar_Tactics_Effect.lift_div_tac
               (fun uu___1 -> Prims.strcat "let " uu___))