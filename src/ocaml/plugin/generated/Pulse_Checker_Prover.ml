    ...
    fun pst0 ->
      FStar_Tactics_Effect.tac_bind
        ...
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                 (Prims.of_int (123)) (Prims.of_int (2)) (Prims.of_int (172))
                 (Prims.of_int (32)))))
        (Obj.magic
                ...
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                         ...
                         (Prims.of_int (198)) (Prims.of_int (55)))))
                (FStar_Sealed.seal
                   (Obj.magic
                      (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                         (Prims.of_int (198)) (Prims.of_int (56))
                         (Prims.of_int (265)) (Prims.of_int (97)))))
                (Obj.magic
                         ...
                         FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.Prover.fst"
                                    (Prims.of_int (198)) (Prims.of_int (30))
                                    (Prims.of_int (198)) (Prims.of_int (54)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.Prover.fst"
                           ...
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    ...
                                    (Prims.of_int (200)) (Prims.of_int (33)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range
                                    "Pulse.Checker.Prover.fst"
                    ...
                    (FStar_Sealed.seal
                       (Obj.magic
                          (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                             ...
                             (Prims.of_int (332)) (Prims.of_int (65)))))
                    (FStar_Tactics_Effect.lift_div_tac
                       (fun uu___ ->
              ...
              fun res_ppname ->
                FStar_Tactics_Effect.tac_bind
                  ...
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                           ...
                           (Prims.of_int (342)) (Prims.of_int (48)))))
                  (FStar_Tactics_Effect.lift_div_tac
                     (fun uu___ ->
                  ...
                  (fun uu___ ->
                     (fun uvs ->
                        Obj.magic
                          (try_frame_pre_uvs g ctxt () uvs t c d res_ppname))
                       uu___)
let (prove_post_hint :
  Pulse_Typing_Env.env ->
    Pulse_Syntax_Base.vprop ->
              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                       ...
                       (Prims.of_int (351)) (Prims.of_int (46)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.Prover.fst"
                       (Prims.of_int (353)) (Prims.of_int (2))
                       (Prims.of_int (397)) (Prims.of_int (102)))))
              (FStar_Tactics_Effect.lift_div_tac
                 (fun uu___ ->
